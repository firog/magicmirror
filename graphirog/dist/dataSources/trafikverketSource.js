...
var TrafikverketApi = (function (_super) {
    __extends(TrafikverketApi, _super);
    function TrafikverketApi() {
        var _this = _super.call(this) || this;
        _this.baseURL = 'http://api.trafikinfo.trafikverket.se/v1.3/data.json';
        return _this;
    }
    TrafikverketApi.prototype.getLateTrains = function (fromStation, endStation) {
    ...
    return TrafikverketApi;
}(apollo_datasource_rest_1.RESTDataSource));
exports.TrafikverketApi = TrafikverketApi;
